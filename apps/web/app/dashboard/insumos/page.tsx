                    ...
                    <tbody className="divide-y divide-border">
                      {filteredSolicitudes.map((sol) => (
                        <tr key={sol.id} className="hover:bg-muted transition-colors group">
                          ...
                          <td className="px-6 py-5 font-black text-foreground text-sm text-center tabular-nums">{sol.cantidad}</td>
                ...
                <GlassCard className="bg-card/60 border-border">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-black text-foreground">2 Referencias</p>
                    </div>
                  </div>
                </GlassCard>
              </div>
